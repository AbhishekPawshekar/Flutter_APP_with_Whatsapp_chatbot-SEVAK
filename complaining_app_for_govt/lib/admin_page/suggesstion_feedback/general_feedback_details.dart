...
class general_feedback_details extends StatefulWidget {
  general_feedback_details({Key key}) : super(key: key);
  @override
  _general_feedback_detailsState createState() => _general_feedback_detailsState();
}
int feedback_data_length;

class _general_feedback_detailsState extends State<general_feedback_details> {
  ...
  Future get_data() async {
    List data=await get_data_with_2_where_condition('feedback','area', current_email,'type','general');
